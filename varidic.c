...
int sum(int count,...) 
{
    ...
    va_list int_argument;
    va_start (int_argument , count);
    
    for (int i=0;i<count;i++)

    {
    	//printf("int_argument = %d\n",va_arg(int_argument, int));
        sum_v = sum_v + va_arg(int_argument, int);
    }
...
int min(int count,...) 
{
    ...
    for (int i=0;i<count;i++)
    {
    	int comp = va_arg(int_argument, int);
    	//printf("int_argument = %d\n",va_arg(int_argument, int));
